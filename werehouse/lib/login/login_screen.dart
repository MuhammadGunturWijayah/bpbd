...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      // Send these credentials to your backend for verification and further processing
      Response response = await dio.post(
        '${Global.baseUrl}/google-signin',
        data: {
      ...
      _showFailedSnackBar(context, 'Failed to sign in with Google: $e');
    } finally {
      _hideLoadingDialog(context);
    }
  }
